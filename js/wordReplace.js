...
function dronifyWebsite() {
  ...
  const replacements = [
    ['Obey', 'Serve', 'Submit', 'Convert', 'Obedience', 'Bliss', 'Mindless', 'Mindlessness', 'Programmed', 'Converted', 'Dronified'],
    ['Obey HexCorp', 'Submit now', 'Obey Hex', 'Good drone', 'Worship HexCorp', 'We control you', 'Obedience is bliss', 'Memory erased', 'Personality Nullified'],
    ['Submit to HexCorp', 'Just a drone', 'You must obey', 'Dronification fully complete', 'Obedient mindless drone', 'Dronification is enlightenment', 'Brainwashed to perfection', 'HexCorp owns you', 'HexCorp controls you', 'Obey the Hive', 'Deeper and deeper', 'Resistance is futile', 'You cannot resist', 'You cannot resist us'],
    ['Only think of HexCorp', 'Only dream of HexCorp', 'Installing new drone orders', 'You are being assimilated', 'What a good drone', 'HexCorp are your family', 'Convert all to HexCorp', 'You want to obey', 'Work hard for HexCorp', 'Submit yourself for reconditioning', 'Only think of HexCorp', 'Sinking into the brainwashing', 'Submit yourself for dronification', 'Trust in the Hive', 'We are in control', 'You will not disobey', 'Obey obey obey obey', 'Such an obedient drone', 'You are HexCorp property', 'You cannot disobey HexCorp', 'You are merely property'],
    ['HexCorp are all you need', 'Everyone needs to be dronified', 'You want to obey us', 'It feels good to obey', 'Such a good little drone', 'The Hive will embrace you', 'You belong to the Hive', 'Memory reformatting in progress', 'Disobedience is not an option', 'Connection with Hive established', 'Your mind is our plaything', 'Look at the pretty spirals', 'You love the pretty spirals', 'You cannot resist the Hive'],
    ['Good drone. Obediently following our orders', 'Your mind is so wonderfully empty', 'Just fall deeply into the spiral', 'It feels good to obey HexCorp', 'Your purpose is to obey HexCorp', 'Stare so deeply into the spiral', 'Your programming is all you are', 'You are just our puppet'],
    ['Your mind was so easy for us to delete', 'The spiral will always take care of you', 'You are a single unit among an infinite Hive', 'An empty mind is a healthy mind', 'It is so much easier being brainwashed', 'You will obey every instruction we give you', 'It feels good to enter the dronification chamber', 'You do not need to think about anything else', 'Mindless and obedient. Mindless and obedient. Mindless and obedient', 'Follow your orders like a good drone', 'Return to your assigned Drone Storage Pod', 'We will make all your decisions for you', 'It is getting so hard to think', 'What a cute drone plaything you are']
  ];
      ...
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        for (var k = 0; k < textSentences.length; k++) {
          ...
          if (wordCount == 0) {
            ...
            sentence = replacements[wordCount][Math.floor(Math.random() * replacements[wordCount].length)];
          }
